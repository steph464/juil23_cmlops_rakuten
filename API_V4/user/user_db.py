...
#chemin_absolu = '/home/workspace_3/API_rakuten/BDD/user/users.json'
chemin_relatif = '../BDD/user/users.json'

# Fonction pour charger les données des utilisateurs depuis le fichier JSON
def load_users():
    try:
        with open(chemin_relatif, "r") as file:
...
def save_users(users_data):
    with open(chemin_relatif, "w") as file:
