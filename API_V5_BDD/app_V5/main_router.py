...
from operations.operations_router import operations as operations

api = FastAPI(
    openapi_tags=[
        {'name': 'Default'},
        {'name': 'Users', 'description': 'Admin functionalities'},
        {'name': 'Operations', 'description': 'maintenance et inférence'},
...
api.include_router(operations,prefix="/Operations", tags=["Operations"]  )
